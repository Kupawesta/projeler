...
public class Okul_Otomasyonu {
	...
	int sinifsayisi=0;
 	...
 	public void Ekran() {
		...
		System.out.println("3- Öðrenci Atama");
		System.out.println("4- Sýnýf Listesi");
		System.out.println("5- Ders Tanýmlama");
		System.out.println("6- Not Ekleme");
		System.out.println("7- Not Görüntüleme");
		System.out.println("8- Öðrenci Arama");
 	...
 	public int tamsayiAl() {
 		...
 		do {
			...
			System.err.println("Lütfen Tamsayý Giriniz....");
			error=true;
			}
 		}while (error);
 		return sayi;
 	...
 	public void Run() {
 		...
 		do {
 			...
 			secim =Seciniz();
	 		switch (secim) {
			case 1:SinifTanýmlama();break;
			case 2:OgrenciTanýmlama();break;
			...
			default:System.err.println("Uygulama Kapatýldý...");break;
			}
 		}while(secim!=0);
 	}
 	public void SinifTanýmlama() {
	 	System.out.println("Sýnýf Adýný Giriniz...:");
	 	Scanner sc = new Scanner(System.in);
	 	String sinifadi= sc.nextLine();
	 	SinifEkle(sinifadi);	
	 	System.out.println("Sýnýf Baþarý ile eklendi...");
 	}
 	public void OgrenciTanýmlama() {
